...
## LangGe design screenshots

Light mode - payment method selection

![Light mode payment method selection](./screenshots/langge-light-select.png)

Light mode - payment QR/address

![Light mode payment QR/address](./screenshots/langge-light-checkout.png)

Dark mode - payment method selection

![Dark mode payment method selection](./screenshots/langge-dark-select.png)

Dark mode - payment QR/address

![Dark mode payment QR/address](./screenshots/langge-dark-checkout.png)
